...
public class Change_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 103, 148, 30));
        jPanel1.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 173, 140, 30));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 177, -1, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String q="UPDATE login SET uname='"+u+"',passwd='"+p+"' WHERE id=1;";
            int result=0;
